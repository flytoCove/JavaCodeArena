...
# 插入测试用户
insert into tb_sys_user values('1','admin','123','',0,'2025-11-30 22:50:00',0,'2025-11-30 22:51:00');

select * from tb_sys_user;

update tb_sys_user set password = '$2a$10$qreAHQtzBqBAu.M2HKKafu2AKW1o2UCp/XADNPPRdUB03WVyeLEQO'
...
create database oj_nacos_local;
show databases;
use oj_nacos_local;
...
GRANT CREATE,DROP,SELECT, INSERT, UPDATE, DELETE ON oj_nacos_local.* TO 'ojtest'@'%';
